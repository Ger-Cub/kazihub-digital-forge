    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="space-y-8 text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Article 3 - Commandes</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Article 4 - Prix et Paiement</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Article 5 - Délais</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Article 7 - Garanties</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Article 8 - Responsabilité</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Article 9 - Litiges</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Article 10 - Contact</h2>
            <p>

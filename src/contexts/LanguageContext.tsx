...
const translations = {
  fr: {
    ...
    'team.lead.title': 'Direction Technique',
    'team.lead.name': 'Gerard Cubaka',
    'team.lead.role': 'Directeur Technique',
    'team.lead2.name': 'Bénédicte Tuteka',
    'team.lead2.role': 'Software Engineer',
    'team.members.title': 'Membres de l\'Équipe',
    'team.member1.name': 'Landry Bitege',
    'team.member1.role': 'Expert en IA',
    'team.member2.name': 'Firmin Nganduli',
    'team.member2.role': 'Product Manager',
    'team.member3.name': 'Birusha Ndegeya',
    'team.member3.role': 'Développeur Fullstack',
    'team.member4.name': 'Joel Magene',
    'team.member4.role': 'UI/UX Designer',
  ...
  en: {
    ...
    'team.lead.title': 'Technical Direction',
    'team.lead.name': 'Gerard Cubaka',
    'team.lead.role': 'Technical Director',
    'team.lead2.name': 'Bénédicte Tuteka',
    'team.lead2.role': 'Software Engineer',
    'team.members.title': 'Team Members',
    'team.member1.name': 'Landry Bitege',
    'team.member1.role': 'AI Expert',
    'team.member2.name': 'Firmin Nganduli',
    'team.member2.role': 'Product Manager',
    'team.member3.name': 'Birusha Ndegeya',
    'team.member3.role': 'Fullstack Developer',
    'team.member4.name': 'Joel Magene',
    'team.member4.role': 'UI/UX Designer',
